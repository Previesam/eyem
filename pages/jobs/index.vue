<template>
  <div class="messages current-item-div">
    ...
    <v-row justify="space-around">
          ...
          <v-list subheader height="85vh" class="pt-5" two-line
            ...
            <div class="overflow-scroll" v-else>
              ...
              >
                ...
                <v-list-item-content class="px-0 mx-0">
                  <v-list-item-subtitle v-text="'Due:'"></v-list-item-subtitle>
                  <v-list-item-subtitle
                    v-text="`27th Jan, 20`"
                  ></v-list-item-subtitle>
                </v-list-item-content>
      ...
      <v-col>
        <v-card elevation="12" width="100%" class="dash-item job-messages">
          <div v-if="currentItem">
            <v-card height="40vh" class="not-rounded">
              <v-card-title class="text-center">
                <v-spacer></v-spacer>
                <div class="my-5 text-center">
                  <v-avatar color="primary" size="50" class="mb-5">
                    AS
                  </v-avatar>
                ...
                <div class="float-left">
                  ...
                  <v-card
                    ...
                    ><v-card-text class="ma-0 py-0 px-2 text-justify"
                      ...
                      Aliquam veniam animi commodi illo quibusdam mollitia
                      labore. Accusamus alias, consequatur in, voluptatum est
                      natus voluptatem iure dolorum nesciunt doloribus officiis
              ...
              <v-card-text>
                <div class="float-right">
                  ...
                  <v-card max-width="400px" class="float-left dash-item"
                    ><v-card-text class="ma-0 py-0 px-2 text-justify"
                      >Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                      Praesentium totam optio animi unde pariatur delectus
                      tempora neque quidem cupiditate voluptatem. Doloribus
                      repellendus pariatur aliquam consequuntur obcaecati ullam
                      suscipit culpa. Expedita.
                    </v-card-text></v-card
                  >
                </div>
              </v-card-text>

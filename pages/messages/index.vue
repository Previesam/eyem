<template>
  <div class="messages">
    <!-- <v-row justify="space-between" d-flex>
      <v-col
        ><span class="mr-5">Filters</span><v-chip>All</v-chip>
        <v-chip class="ml-2">Emails</v-chip>
        <v-chip class="ml-2">Chats</v-chip> <v-chip class="ml-2">Unread</v-chip
        ><v-btn rounded text outlined color="primary" class="float-right"
          ><v-icon left>mdi-plus</v-icon><span>Add New</span></v-btn
        ></v-col
      >
    </v-row> -->
    <v-row justify="space-around">
      <v-col class="conversation-list">
        <v-card elevation="12" width="100%" class="dash-item">
          <v-list subheader height="85vh" class="pt-5"
            ><v-list-item>
              <v-text-field
            ...
            <div class="overflow-scroll" v-if="!searchKeyword">
              ...
              >
                ...
                <v-badge class="mr-5" color="green" content="999+"></v-badge>
              </v-list-item>
            </div>
      ...
      <v-col>
        <v-card elevation="12" width="100%" height="85vh" class="dash-item">
          <div v-if="currentItem">
            <v-app-bar flat class="not-rounded">
            ...
            <v-row class="conversation-view">
              <v-col class="ma-2" cols="12">
                <v-avatar class="ml-2 float-left" color="primary" size="30"
                  >AS</v-avatar
                >
                <v-card
                  width="250"
              ...
              <v-col class="my-2 ml-2" cols="12">
                <v-avatar class="float-right" color="primary" size="30"
                  >AS</v-avatar
                >
                <v-card
                  width="250"
            ...
            <v-bottom-navigation class="chat-nav">
          ...
          <v-card
            v-else
            height="100%"
            class="d-flex justify-center align-center dash-item"
            cols="12"
          >
            <!-- <v-card-title>Please select a conversation to view.</v-card-title> -->
            <div v-for="(group, key) in groupedPeople" :key="key">{{ groupedPeople }} <p v-for="person in groupedPeople.key" :key="person.name">{{ person.name }}</p></div>
          </v-card>
        </v-card>
      </v-col>
    </v-row>
...
export default {
  ...
  computed: {
    ...
    groupedPeople() {
      return this.groupBy(this.people, 'age');
    },
  },
  methods: {
    active(item) {
